...
//
//   Project URL  → HARVEST_SUPABASE_URL  (Supabase → Project Settings → API, no /rest/v1/ suffix)
//   anon public  → HARVEST_SUPABASE_ANON_KEY  (same page — the anon key, NOT service_role)
self.HARVEST_SUPABASE_URL = "https://YOUR_PROJECT.supabase.co";
self.HARVEST_SUPABASE_ANON_KEY = "YOUR_ANON_KEY";
...
self.HARVEST_FIGMA_CLIENT_ID = "YOUR_FIGMA_OAUTH_CLIENT_ID";
...
self.HARVEST_NOTION_CLIENT_ID = "YOUR_NOTION_OAUTH_CLIENT_ID";
